                                    ...
                                    <div>
                                        ...
                                        <div className="mt-1">
                                            <input
                                                ...
                                                required
                                                maxLength={8}
                                                className="w-full px-3 py-2 rounded-lg border border-gray-300 shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-700 focus:border-emerald-700 uppercase"
